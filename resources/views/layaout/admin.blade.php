        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
             ...
             <li>
              <a href="#">
                <i class="far fa-comment fa-2x"></i> <span class="menu-texto">Comentarios</span>
                <small class="label pull-right bg-red">PDF</small>
              </a>
            </li>
            <li>
              <a href="#">
                <i class="fas fa-cogs fa-2x"></i> <span class="menu-texto">Ajustes</span>
                <small class="label pull-right bg-red">PDF</small>
              </a>
            </li>
            <li>
              <a href="#">
                <i class="fa fa-info-circle fa-2x"></i> <span class="menu-texto"> Acerca De...</span>
